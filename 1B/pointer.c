...
int main(int argc, char* argv[]){
	...
	//step 3: modification
	puts("========step 3==========");
	modify(cmok, "mok", 13000, "unknown");

	puts("--results of modify--");
	print_idserver(cmok);

	modify_by_pointer(&cmok,"mok", 13000, "unknown");
	...
	//It looks like assignment performs a deepcopy of the structure because cmok retained even its status and id when albi's status and id were overwritten and 
	//step 4: pointers
	puts("========step 4========");
	albi = cmok;
	//print_idserver(albi);
